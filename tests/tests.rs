                    ...
                    ("foo".into(), State {
                        ...
                        transitions: [
                            Transition {
                                ...
                                ordered_condition: Condition::atom("t < 10".into()) & Condition::atom("t < 9".into()),
                                actions: [].into_iter().collect(),
                                new_state: Some("bar1".into()),
                            },
                            Transition {
                                unordered_condition: Condition::atom("t < 10".into()) & !Condition::atom("t < 9".into()),
                                ordered_condition: Condition::atom("t < 10".into()),
                                actions: [].into_iter().collect(),
                                new_state: Some("bar2".into()),
                            },
                            Transition {
                                unordered_condition: !Condition::atom("t < 10".into()) & Condition::atom("t < 8".into()),
                                ordered_condition: Condition::atom("t < 8".into()),
                                actions: [].into_iter().collect(),
                                new_state: Some("baz1".into()),
                            },
                            Transition {
                                unordered_condition: !Condition::atom("t < 10".into()) & !Condition::atom("t < 8".into()),
                                ordered_condition: Condition::constant(true),
                                actions: [].into_iter().collect(),
                                new_state: Some("baz2".into()),
                            },
                        ].into_iter().collect(),
                    }),
                    ("bar1".into(), State {
                    ...
                    ("first state".into(), State {
                        ...
                        transitions: [
                            Transition {
                                ...
                                new_state: Some("second state".into()),
                            },
                        ].into_iter().collect(),
                    }),
                    ...
                    ("::junction-0::".into(), State {
                        ...
                        transitions: [
                            Transition {
                                ...
                                actions: [].into_iter().collect(),
                                new_state: Some("xyz".into()),
                            },
                            Transition {
                                unordered_condition: !Condition::atom("foo > 1024".into()),
                                ordered_condition: Condition::constant(true),
                                actions: [].into_iter().collect(),
                                new_state: Some("abc".into()),
                            },
                        ].into_iter().collect(),
                    }),
                    ("xyz".into(), State {
                    ...
                    ("something".into(), State {
                        ...
                        transitions: [
                            Transition {
                                ...
                                new_state: Some("::junction-1::".into()),
                            },
                        ].into_iter().collect(),
                    }),
                    ("::junction-0::".into(), State {
                    ...
                    ("first".into(), State {
                        ...
                        transitions: [
                            Transition {
                                ...
                                actions: [].into_iter().collect(),
                                new_state: Some("mid".into()),
                            },
                            Transition {
                                unordered_condition: !Condition::atom("a == 1".into()),
                                ordered_condition: Condition::constant(true),
                                actions: [].into_iter().collect(),
                                new_state: Some("last".into()),
                            },
                        ].into_iter().collect(),
                    }),
                    ("mid".into(), State {
                    ...
                    ("first".into(), State {
                        ...
                        transitions: [
                            Transition {
                                ...
                                ordered_condition: Condition::atom("a == 1".into()),
                                actions: [].into_iter().collect(),
                                new_state: Some("mid 1".into()),
                            },
                            Transition {
                                unordered_condition: !Condition::atom("a == 1".into()),
                                ordered_condition: Condition::constant(true),
                                actions: [].into_iter().collect(),
                                new_state: Some("mid 2".into()),
                            },
                        ].into_iter().collect(),
                    }),
                    ("mid 1".into(), State {
            ...
            ("my state".into(), StateMachine {
                ...
                states: [
                    ("start".into(), State {
                        ...
                        transitions: [
                            Transition {
                                unordered_condition: Condition::atom("after(2, sec)".into()),
                                ordered_condition: Condition::atom("after(2, sec)".into()),
                                actions: [].into_iter().collect(),
                                new_state: Some("::junction-0::".into()),
                            },
                            Transition {
...
#[test]
fn test_wait_5() {
    let proj = Project::compile(include_str!("projects/wait-5.xml"), None, Settings::default()).unwrap();
    assert_eq!(proj, Project {
        name: "wait".into(),
        role: "myRole".into(),
        state_machines: [
...
#[test]
fn test_wait_6() {
    let proj = Project::compile(include_str!("projects/wait-6.xml"), None, Settings::default()).unwrap();
    assert_eq!(proj, Project {
        name: "wait".into(),
        role: "myRole".into(),
        state_machines: [
...
#[test]
fn test_wait_7() {
    let proj = Project::compile(include_str!("projects/wait-7.xml"), None, Settings::default()).unwrap();
    assert_eq!(proj, Project {
        name: "wait".into(),
        role: "myRole".into(),
        state_machines: [
...
#[test]
fn test_wait_8() {
    let proj = Project::compile(include_str!("projects/wait-8.xml"), None, Settings::default()).unwrap();
    assert_eq!(proj, Project {
        name: "wait".into(),
        role: "myRole".into(),
        state_machines: [
                    ...
                    ("start".into(), State {
                        ...
                        transitions: [
                            Transition {
                                ...
                                ordered_condition: Condition::atom("after(3, sec)".into()),
                                actions: [].into_iter().collect(),
                                new_state: Some("::junction-2::".into()),
                            },
                            Transition {
                                unordered_condition: !Condition::atom("after(3, sec)".into()),
                                ordered_condition: Condition::constant(true),
...
#[test]
fn test_wait_9() {
    let proj = Project::compile(include_str!("projects/wait-9.xml"), None, Settings::default()).unwrap();
    assert_eq!(proj, Project {
        name: "wait".into(),
        role: "myRole".into(),
        state_machines: [
...
#[test]
fn test_wait_10() {
    let proj = Project::compile(include_str!("projects/wait-10.xml"), None, Settings::default()).unwrap();
    assert_eq!(proj, Project {
        name: "wait".into(),
        role: "myRole".into(),
        state_machines: [
